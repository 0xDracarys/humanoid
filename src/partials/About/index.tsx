    ...
    <Section name="about" className={style.root}>
              ...
              <div>
                <Trans
                  ...
                  components={{
                    ...
                    ImageTCMGTK: <ImageTrigger name="Dracarys" sizes={[2, 3]} />
                  }}
                />
              </div>
            </ContentBlock>
      ...
      <Container grid>
        <Row start={1} end={3}>
          <ContentBlock>
            <List>
              <ListItem end="">HTML, CSS, Javascript, Three.js, Node, Typescript</ListItem>
              <ListItem end="">Microsoft Server, Kubernetes, SQL, AWS, Docker, Hypervisor (VMWARE, Hyper-V)</ListItem>
              <ListItem end=""> Cyber Security, Security Operations Safety and policy compliance</ListItem> 
              <ListItem end="">Ansible, Salesforce</ListItem>
              <ListItem end=""> Git, Linux/Unix, Bash , Python</ListItem>
